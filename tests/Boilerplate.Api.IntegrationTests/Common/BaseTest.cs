...
public abstract class BaseTest : IAsyncLifetime
{
    ...
    protected async Task<HttpResponseMessage> PatchAsync(string address, object? data = null,
    ...
    protected static async Task<HttpResponseMessage> RequestAsync(string address, object? data,
